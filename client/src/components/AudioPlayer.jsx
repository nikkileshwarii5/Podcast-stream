import { Pause, PlayArrow,SouthRounded, VolumeUp } from '@mui/icons-material'
    ...
    return (
        <Container>
            ...
            <Player>
                <Controls>
                    <IcoButton>
                        <SkipPreviousRoundedIcon onClick={() => goToPreviousPodcast()} />
                    </IcoButton>
                    <Audio
                        ref={audioRef}
                    ...
                    />
                    <IcoButton>
                        <SkipNextRoundedIcon onClick={() => goToNextPodcast()} />
                    </IcoButton>
                </Controls>
            </Player>
            <Sound>
